...
from utils.data_preparation import df_all_creator, df_train_creator, \
...
def main():
    ...
    parser.add_argument('-w', type=int, default=10,
                        help='Input sources', required=True)
    parser.add_argument('-s', type=int, default=10, help='sequence length')
    parser.add_argument('--index', type=int, default='non',
                        help='data representation:non, sfa or pca')
